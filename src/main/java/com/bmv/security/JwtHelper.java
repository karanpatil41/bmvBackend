...
//3)  Create JWTHelper  class This class contains method related to perform 
//operations with jwt token like generateToken, validateToken etc.
...
public class JwtHelper {
    ...
    public String getUsernameFromToken(String token) {
    	logger.info("JwtHelper--getUsernameFromToken()");
